...
const MENU: MenuGroup[] = [
  ...
  },
  {
    group: 'DINERO',
    items: [
      { to: '/pagos', label: 'Pagos', roles: ['super_admin', 'admin'], icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z' },
      { to: '/caja', label: 'Caja', roles: ['super_admin', 'admin'], icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
      { to: '/gastos', label: 'Gastos', roles: ['super_admin', 'admin'], icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V7m0 1v8m0 0v1' },
      { to: '/reportes', label: 'Reportes', roles: ['super_admin', 'admin'], icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
    ],
  },
  {
    group: 'CANCHA',
    items: [
      { to: '/inventario', label: 'Inventario', roles: ['super_admin', 'admin', 'auxiliar'], icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
  ...
  },
  {
    group: 'SISTEMA',
    items: [
      { to: '/alertas', label: 'Alertas', roles: ['super_admin', 'admin'], icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
      { to: '/whatsapp', label: 'WhatsApp', roles: ['super_admin', 'admin'], icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z' },
        ...
        <div className="px-2 py-3 border-t border-slate-700/50 flex-shrink-0 space-y-1">
          {!collapsed && user && (
            <div className="px-3 py-2 mb-1">
              <p className="text-xs text-slate-500 truncate">{user.role === 'super_admin' ? 'Super Admin' : user.role === 'admin' ? 'Admin' : user.role === 'entrenador' || user.role === 'profe' ? 'Profesor' : 'Auxiliar'}</p>
            </div>
          )}
          <button
